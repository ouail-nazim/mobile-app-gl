...
public class JustificationsActivity extends Activity {
        CustomProgressDialog  progressDialog;
        String urlGet="http://192.168.1.2/gsa/justifications.php";
        ...
        private class GetDataAsyncTask extends  AsyncTask<Void, Void, Void> {
                ...
                protected void onPostExecute(Void result) {
                        ...
                        if(success==1)
                        { 
                                Toast.makeText(getApplicationContext(), "Vos Absences Justifiées", Toast.LENGTH_LONG).show();
